...
<template lang="pug">
.layout
  header.bg-accent.border-bottom: .container
    nav.navbar.navbar-light
      a.navbar-brand
        ClientOnly: VueTyper(:text='what' caret-animation='blink')
      ul.navbar-nav
        li.nav-item
      ...
      .row
        ...
        .col-sm-6.col-12
          ul.nav.justify-content-end
            li.nav-item: a.nav-link(href="mailto:irvinjohnathan@gmail.com" target="_blank")
            ...
            li.nav-item: a.nav-link(href="https://github.com/JohnnyIrvin" target="_blank")
            ...
            li.nav-item: a.nav-link(href="https://twitter.com/_JohnnyIrvin" target="_blank")
...
export default Vue.extend({
  ...
  data: function() {
    return {
      what: ['Engineer', 'Journalist', 'Entrepreneur'],
    }
  }
})
</script>
